...
toggler icons:
 <span title="toggle Dark | light mode"  class="nav-link collapse-navbar  px-1 nav-link-no-btn  theme-toggle collapse-navbar">
                        <svg class="sun" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="eveno24 24dd"  d="M12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16ZM12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18Z"
                                fill="var(--color)" />
